#Coded By Alex Arathorn
#A Product Of ALEX ARATHORN
...
if(sec==K3Y):
	...
	logopsb("\033[3;90m			A Product Of AlexArathorn\033[0;92m")
	time.sleep(0.6)
	logopsb("\033[34m\n|****************************************************| \n|\033[3m Author   : AlexArathorn                               \033[0;34m|\n|\033[3m Tool     : Arathorn Bomber                            \033[0;34m|\n|\033[3m Version  : 2.0                                     \033[0;34m|\n|\033[3m Link     : https://www.github.com/Toxic-Noob/	     \033[0;34m|\n|\033[3m Coded By : DarkSlad3        		     	     \033[0;34m|\n******************************************************")
	time.sleep(0.8)
	...
	while op<=tr:
		try:
			...
			if(op==tr):
				psb("\n[*] Bombing Finished!!\n")
				time.sleep(0.5)
				psb("[!] Sent "+tr2+" Massages To 0"+number+" By ArathornBomber.....\n\033[0;40;37m")
				time.sleep(0.7)
				exit()
			else:
				time.sleep(4)
